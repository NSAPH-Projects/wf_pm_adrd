...
zip_count_hosp_outcomes <- read_rds(paste0(data_path, "/data_process/hosp_dta/hosp_after_first_adrd_zip_2006cohort.rds")) %>% 
...
gen_data4casecross_year <- function(year){
  data_w_lagged_wfpm <- read_fst(paste0(data_path_data4casecross, "/data_w_lagged_wfpm/data4casecross_", year, "_2006cohort.fst")) %>% 
  ...
  data_w_lagged_temp_rh <- read_fst(paste0(data_path_data4casecross, "/data_w_lagged_temp_rh/data4casecross_", year, "_2006cohort.fst")) %>% 
...
write_fst(data4casecross_zip_final, '/n/dominici_nsaph_l3/Lab/projects/wfpm_adrd_hosp/data/data_process/data4casecross/data_w_all_vars/data4casecross_zip_2006cohort.fst', compress = 100)
