...
# Author: Vivian
# Date: 5/25/24
# Goal: create control days for each hospital admission for 2006 cohort
####**********************
...
adrd_zip <- read_rds(paste0(data_path, "data_process/hosp_dta/hosp_after_first_adrd_case_days_2006cohort.rds")) %>% 
...
# check
cntrl_days_zip_2006 <- read_fst(paste0(data_path_external, 'cntrl_days_zip_2006_2006cohort.fst'))
