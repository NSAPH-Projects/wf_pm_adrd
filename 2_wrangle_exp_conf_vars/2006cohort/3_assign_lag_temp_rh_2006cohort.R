...
# Author: Vivian
# Date: 3/25/24
# Goal: assign lagged days of confounders (temp, rh, non wf pm) for 2006 cohort
####**********************
...
end_time <- Sys.time() # 1.177 hours (7 lags); 2.46 hours (14 lags)
end_time - start_time 


# Check --------------------------------------------------------------------
data4casecross_2010 <- read_fst(paste0(data_path, '/data_process/data4casecross/data_w_lagged_temp_rh/data4casecross_2010_2006cohort.fst'))
zip_1001 <- data4casecross_2010 %>% 
  filter(zip == 1001)
