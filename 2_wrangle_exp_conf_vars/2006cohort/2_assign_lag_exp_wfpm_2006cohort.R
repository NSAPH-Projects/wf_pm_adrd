...
# Author: Vivian
# Date: 3/25/14
# Goal: assign lagged days of wildfire pm for 2006 cohort
####**********************
...
# data4casecross_zip <- read_fst(paste0(data_path, "data_process/case_cntrl_days/cntrl_days_zip_2006_2006cohort.fst")) %>% 
...
for (year in (2006:2016)){
  ...
  data4casecross_zip <- read_fst(paste0(data_path, "data_process/case_cntrl_days/cntrl_days_zip_", year, "_2006cohort.fst"))
  ...
  data4casecross_zip %>%
    ...
    fst::write_fst(paste0(data_path, 'data_process/data4casecross/data_w_lagged_wfpm/',
                          'data4casecross_', ActiveYear, '_2006cohort.fst'))
...
# Check --------------------------------------------------------------------
data4casecross_2006 <- read_fst(paste0(data_path, 'data_process/data4casecross/data_w_lagged_wfpm/data4casecross_2006_2006cohort.fst'))
test_1001 <- data4casecross_2006 %>% 
  filter(zip == "1001")
names(data4casecross_2006)
