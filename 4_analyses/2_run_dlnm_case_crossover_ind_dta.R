...
data_path_stratification_vars <- '/n/holyscratch01/LABS/dominici_nsaph/Lab/projects/wfpm_adrd_hosp/data/data_process/stratification_vars/'
# output_path <-"/n/holyscratch01/LABS/dominici_nsaph/Lab/projects/wfpm_adrd_hosp/data/data_process/output/" #update to be scratch space
...
data4casecross_ind <- read_fst('/n/dominici_nsaph_l3/Lab/projects/wfpm_adrd_hosp/data/data_process/data4casecross/data_w_all_vars/data4casecross_ind.fst')
...
analyze_dlnm_wfpm_stratification <- function(ExpTerm, CaseType, Stratify_Variable,  
  ...
  for (strat_unique_level in 1:length(strat_unique_levels)){
    ...
    # filter to (1) days with cases along with their controls (bc a case cannot be a day with 0 events)
...
# circulatory; ER = linear; LR = 4
## sex 
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "circ_prmy_out", Stratify_Variable = "sex_group",  
                                 ERConstraint = "linear", LRConstraint = "4dfevenknots")

## urbanicity 
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "circ_prmy_out", Stratify_Variable = "urbanicity",  
                                 ERConstraint = "linear", LRConstraint = "4dfevenknots")

## age 
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "circ_prmy_out", Stratify_Variable = "age_category",  
                                 ERConstraint = "linear", LRConstraint = "4dfevenknots")

## pov 
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "circ_prmy_out", Stratify_Variable = "pov_category",  
                                 ERConstraint = "linear", LRConstraint = "4dfevenknots")

# ed visit
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "circ_prmy_out", Stratify_Variable = "edvisit_category",  
                                 ERConstraint = "linear", LRConstraint = "4dfevenknots")


# respiratory; ER = linear; LR = 5
## sex
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "resp_prmy_out", Stratify_Variable = "sex_group",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## urbanicity
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "resp_prmy_out", Stratify_Variable = "urbanicity",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## age
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "resp_prmy_out", Stratify_Variable = "age_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## pov
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "resp_prmy_out", Stratify_Variable = "pov_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## ed visit
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "resp_prmy_out", Stratify_Variable = "edvisit_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

# anxiety; ER = linear; LR = 5
## sex
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "anxty_prmy_out", Stratify_Variable = "sex_group",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## urbanicity
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "anxty_prmy_out", Stratify_Variable = "urbanicity",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## age
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "anxty_prmy_out", Stratify_Variable = "age_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## pov
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "anxty_prmy_out", Stratify_Variable = "pov_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## ed visit
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "anxty_prmy_out", Stratify_Variable = "edvisit_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

# # depression; ER = linear; LR = 4
## sex
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "dep_prmy_out", Stratify_Variable = "sex_group",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## urbanicity
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "dep_prmy_out", Stratify_Variable = "urbanicity",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## age
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "dep_prmy_out", Stratify_Variable = "age_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## poverty
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "dep_prmy_out", Stratify_Variable = "pov_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")

## edvisit
analyze_dlnm_wfpm_stratification(ExpTerm = 'ind_daily_wfpm', dta = data4casecross_ind,
                                 CaseType = "dep_prmy_out", Stratify_Variable = "edvisit_category",  
                                 ERConstraint = "linear", LRConstraint = "5dfevenknots")
